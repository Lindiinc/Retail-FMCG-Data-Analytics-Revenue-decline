...
• Stores: 45 store records with format, location, and management info
• Products: Imbewu's product catalogue across 5 categories
• Customers: loyalty programme members and their tier (Bronze / Silver / Gold)
• Transactions: every till receipt issued in the period
